namespace Moonad.Tests.State
{
    ...
    {
        [Fact]
        public void ImplicitConversionFromValueProducesStateReturningSameState()
        {
            // Arrange
            var initialState = 42;
            var value = "hello";
        ...
        [Fact]
        public void ConstructorAssignsFunctionThatTransformsStateAndValue()
        {
            // Arrange
            var initialState = 10;
        ...
        [Fact]
        public void FunctionCanBeInvokedMultipleTimesIsPureGivenSameInput()
        {
            // Arrange
            var initialState = 5;
        ...
        [Fact]
        public void FunctionCanHandleDifferentStatesIndependently()
        {
            // Arrange
        ...
        [Fact]
        public void ImplicitConversionWorksForValueTypes()
        {
            // Arrange
            var initialState = -3;
            var value = 123;
        ...
        [Fact]
        public void FunctionReturnsTupleWithNamedMembersValueAndState()
        {
            // Arrange
            var initialState = 1;
